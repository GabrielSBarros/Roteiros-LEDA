...
public class StudentBSTTest {
	...
	public void testSearch() {
 	...
 	public void testSort() {
 		Integer[] ordenado = { -40, -34, 0, 2, 5, 6, 9, 12, 23, 67, 76, 232 };
 		Integer[] array = { 6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40 };
 		assertArrayEquals(ordenado, tree.sort(array));
 	...
 	public void reverseOrder() {
 		...
 		Integer[] ordenado = { -40, -34, 0, 2, 5, 6, 9, 12, 23, 67, 76, 232 };
 		Integer[] invertido = { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
	
 		Integer[] array = { 6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40 };
 		
 		assertArrayEquals(ordenado, tree.sort(array));
 		assertArrayEquals(invertido, tree.reverseOrder());
